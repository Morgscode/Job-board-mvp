...
function JobLister(props) {
    ...
    return (
        <div>
            <div className="card">
                <DataTable value={props.jobs} responsiveLayout="scroll">
                    <Column field="title" header="Title"></Column>
                    <Column field="active" header="Open" body={formatActive}></Column>
                    <Column field="createdAt" header="Created" body={formatCreatedDate}></Column>
                    <Column field="deadline" header="Closing date" body={formateDeadline}></Column>
                </DataTable>
            </div>
        </div>
    );
